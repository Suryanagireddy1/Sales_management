...
def seed_data():
    ...
    names = ["Aarav","Vivaan","Aditya","Vihaan","Arjun","Reyansh","Sai","Krishna","Ishaan","Surya","Ashok","Ravi","Rahul","Vikram"]
...
def add_bill():
    ...
    if request.method == "POST":
        ...
        db_execute(cur,"INSERT INTO bills (customer_id,bill_date,total) VALUES (%s,%s,%s)",
...
def add_customer():
    ...
    if request.method == "POST":
        ...
        if customer_id:   # If ID entered → update existing
            db_execute(
                cur,
